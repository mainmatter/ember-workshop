...
&shy;<!-- .element: class="r-stretch" --> ![](assets/data_model_diagram.png)
...
&shy;<!-- .element: class="r-stretch" --> ![](assets/ember_data_find_record_diagram.png)
...
&shy;<!-- .element: class="r-stretch" --> ![](assets/ember_data_find_record_with_update_diagram.png)
...
&shy;<!-- .element: class="r-stretch" --> ![](assets/serializer_find_record_diagram.png)

---

&shy;<!-- .element: class="r-stretch" --> ![](assets/serializer_save_diagram.png)
...
&shy;<!-- .element: class="r-stretch" --> ![](assets/json_api_logo_fixed.png)
