...
&shy;<!-- .element: class="r-stretch" --> ![](assets/routing_overview.png)
...
&shy;<!-- .element: class="r-stretch" --> ![](assets/music_player_template_areas_outline.png)

---

&shy;<!-- .element: class="r-stretch" --> ![](assets/application_template_scope.png)

---

&shy;<!-- .element: class="r-stretch" --> ![](assets/music_template_scope.png)

---

&shy;<!-- .element: class="r-stretch" --> ![](assets/music_queue_template_scope.png)
...
&shy;<!-- .element: class="r-stretch" --> ![](assets/loading_template_scope.png)

---

&shy;<!-- .element: class="r-stretch" --> ![](assets/album_loading_template_scope.png)
